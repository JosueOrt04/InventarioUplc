...
export const useReactiveList = () => {
    ...
    const fetchAllReactives = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5001/api/reactivos/lista",
  ...
  const deleteReactive = async (codigo) => {
    try {
      await axios.delete(
        `http://localhost:5001/api/reactivos/${codigo}`,
